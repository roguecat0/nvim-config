return {
  ...
  -- custom
  {
    ...
    config = function()
      ...
      -- Basic debugging keymaps, feel free to change to your liking!terminate(
      ...
      -- dapui
      vim.keymap.set('n', '<leader>dt', dapui.toggle, { desc = 'Debug: Toggle ui layour' })
